...
foreach ($files as $file) {
    replace_in_file($file, [
        ...
        'invoicing-integration' => $packageSlug,
        'invoicing-integration_without_prefix' => $packageSlugWithoutPrefix,
        'Skeleton' => $className,
        'skeleton' => $packageSlug,
        'migration_table_name' => title_snake($packageSlug),
        'variable' => $variableName,
        'This package aims to help integrations with invoicing systems' => $description,
    ]);
